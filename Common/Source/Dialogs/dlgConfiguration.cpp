...
//  DWORD dwSpeed[] = {1200,2400,4800,9600,19200,38400,57600,115200};
  ...
  LoadFormProperty(*wf, _T("prpUTCOffset"), iround(XCSoarInterface::SettingsComputer().UTCOffset/1800.0)/2.0);
  ...
  LoadFormProperty(*wf, _T("prpAutoZoom"), XCSoarInterface::SettingsMap().AutoZoom);
  LoadFormProperty(*wf, _T("prpAirspaceOutline"), XCSoarInterface::SettingsMap().bAirspaceBlackOutline);
  LoadFormProperty(*wf, _T("prpLockSettingsInFlight"), XCSoarInterface::LockSettingsInFlight);
  LoadFormProperty(*wf, _T("prpLoggerShortName"), XCSoarInterface::SettingsComputer().LoggerShortName);
  LoadFormProperty(*wf, _T("prpDebounceTimeout"), XCSoarInterface::debounceTimeout);
  ...
  LoadFormProperty(*wf, _T("prpEnableFLARMGauge"), XCSoarInterface::SettingsMap().EnableFLARMGauge);
  LoadFormProperty(*wf, _T("prpAirspaceWarnings"), XCSoarInterface::SettingsComputer().EnableAirspaceWarnings);
  LoadFormProperty(*wf, _T("prpWarningTime"), XCSoarInterface::SetSettingsComputer().WarningTime);
  LoadFormProperty(*wf, _T("prpAcknowledgementTime"), XCSoarInterface::SetSettingsComputer().AcknowledgementTime);
  ...
  LoadFormProperty(*wf, _T("prpEnableTerrain"), XCSoarInterface::SettingsMap().EnableTerrain);
  LoadFormProperty(*wf, _T("prpEnableTopology"), XCSoarInterface::SettingsMap().EnableTopology);
  LoadFormProperty(*wf, _T("prpCirclingZoom"), XCSoarInterface::SettingsMap().CircleZoom);
  ...
  LoadFormProperty(*wf, _T("prpMenuTimeout"), XCSoarInterface::MenuTimeoutMax/2);
  ...
  LoadFormProperty(*wf, _T("prpEnableNavBaroAltitude"), XCSoarInterface::SettingsComputer().EnableNavBaroAltitude);
  ...
  LoadFormProperty(*wf, _T("prpAutoForceFinalGlide"), XCSoarInterface::SettingsComputer().AutoForceFinalGlide);
  LoadFormProperty(*wf, _T("prpBlockSTF"), XCSoarInterface::SettingsComputer().EnableBlockSTF);
  LoadFormProperty(*wf, _T("prpFAIFinishHeight"), settings_task.EnableFAIFinishHeight);
  ...
  LoadFormProperty(*wf, _T("prpHandicap"), XCSoarInterface::SettingsComputer().Handicap);
  ...
  LoadFormProperty(*wf, _T("prpTrailDrift"), XCSoarInterface::SettingsMap().EnableTrailDrift);
  ...
  LoadFormProperty(*wf, _T("prpSetSystemTimeFromGPS"), XCSoarInterface::SettingsMap().SetSystemTimeFromGPS);
  
 
  LoadFormProperty(*wf, _T("prpAbortSafetyUseCurrent"), GlidePolar::AbortSafetyUseCurrent);
  LoadFormProperty(*wf, _T("prpDisableAutoLogger"), !XCSoarInterface::SettingsComputer().DisableAutoLogger);
  ...
  */
  LoadFormProperty(*wf, _T("prpBallastSecsToEmpty"), XCSoarInterface::SettingsComputer().BallastSecsToEmpty);
...
// end fonts
  ...
  LoadFormProperty(*wf, _T("prpAppInverseInfoBox"), Appearance.InverseInfoBox );
  LoadFormProperty(*wf, _T("prpAppDefaultMapWidth"), Appearance.DefaultMapWidth);
  LoadFormProperty(*wf, _T("prpGliderScreenPosition"), iround(XCSoarInterface::SettingsMap().GliderScreenPosition));
  LoadFormProperty(*wf, _T("prpTerrainContrast"), iround(XCSoarInterface::SettingsMap().TerrainContrast*100/255));
  LoadFormProperty(*wf, _T("prpTerrainBrightness"), iround(XCSoarInterface::SettingsMap().TerrainContrast*100/255));
  ...
  LoadFormProperty(*wf, _T("prpAppGaugeVarioSpeedToFly"), Appearance.GaugeVarioSpeedToFly);
  LoadFormProperty(*wf, _T("prpAppGaugeVarioAvgText"), Appearance.GaugeVarioAvgText );
  LoadFormProperty(*wf, _T("prpAppGaugeVarioGross"), Appearance.GaugeVarioGross);
  ...
  LoadFormProperty(*wf, _T("prpAppGaugeVarioBallast"), Appearance.GaugeVarioBallast);
  ...
  LoadFormProperty(*wf, _T("prpLoggerTimeStepCruise"), XCSoarInterface::SettingsComputer().LoggerTimeStepCruise);
  LoadFormProperty(*wf, _T("prpLoggerTimeStepCircling"), XCSoarInterface::SettingsComputer().LoggerTimeStepCircling);
  LoadFormProperty(*wf, _T("prpSnailWidthScale"), XCSoarInterface::SettingsMap().SnailWidthScale);
